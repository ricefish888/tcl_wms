...
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (1, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'tempFileDir', 'P_STRING', '临时文件路径配置', 'd:/temp/tempFile', null, '上传文件存放的临时文件夹', 'wms5', null, null, null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (2, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'imageFileDir', 'P_STRING', '临时文件路径配置', 'd:/temp/imageFile', null, '图片存放的文件夹', 'wms5', null, null, null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (3, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'otherFileDir', 'P_STRING', '临时文件路径配置', 'd:/temp/otherFile', null, '需要永久存放的非图片文件的文件夹', 'wms5', null, null, null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (6, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'maintainTableDecimal', 'P_INT', '页面布局设置', '6', null, '维护屏二维表格如果是小数需要保留的小数位数', 'wms5', null, null, null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (8, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'IS_ASH', 'P_BOOLEAN', '页面布局设置', 'true', '', '右键弹出菜单不可用时变灰或不可见(true－变灰 false－不可见)', 'wms5', null, null, null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (9, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'ACK_CLOSEWINDOW', 'P_STRING', '页面布局设置', 'ALT-X', null, '弹出窗口关闭热键', 'wms5', null, null, null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (10, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'reportURL', 'P_STRING', '报表服务器配置', 'http://117.78.60.203:8088/qswms/reportJsp/showReport.jsp', '', '报表服务器URL地址', 'wms5', null, null, null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (11, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'clientUserInfo', 'P_BEAN', '全局变量设置', '', 'userInfoInClient', '前台用户登陆时显示的用户信息（如：当前用户：admin）', 'wms5', null, null, null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (12, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'round', 'P_BOOLEAN', '页面布局设置', 'true', null, '小数位数处理时是否四舍五入(默认四舍五入)', 'wms5', null, null, null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (13, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'imageSource', 'P_STRING', '临时文件路径配置', 'd:/temp/image/source', null, '影像归档图片源文件夹', 'wms5', null, null, null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (14, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'imageTarget', 'P_STRING', '临时文件路径配置', 'd:/temp/image/target', null, '影像归档图片目标文件夹', 'wms5', null, null, null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (16, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'IMPORT_REPLACE', 'P_STRING', '全局变量设置', 'false', null, '导入业务数据时是否替换已存在业务数据(true-替换,false-不替换)', 'wms5', null, null, null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (17, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'SESSION_USERS', 'P_BEAN', '全局变量设置', '', 'userSession', '当前用户全局变量', 'wms5', null, null, null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (18, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'SAVE_SYSTEM_LOG', 'P_STRING', '全局变量设置', 'true', null, '是否开启保存操作日志', 'wms5', 1, 'admin', null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (19, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'APPROVE_NUMBER_PAGE', 'P_INT', '全局变量设置', '20', null, '审批页面分页数', 'wms5', 1, 'admin', null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (20, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'DISPLAY_PAGE_HELP', 'P_STRING', '全局变量设置', 'true', '', '是否显示查看页面路径提示', 'wms5', 1, 'admin', null, 7, 'test5', to_date('2011-08-08','yyyy-MM-dd'));
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (21, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'EXPORT_SUPPORT', 'P_STRING', '全局变量设置', 'true', '', '标准表格页面是否支持导出,刷新', 'wms5', 1, 'admin', null, 2, 'test',  to_date('2011-08-08','yyyy-MM-dd'));
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (22, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'SESSION_MODEL', 'P_BEAN', '全局变量设置', '', 'bussinessModelSession', '当前模型全局变量', 'wms5', null, null, null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (23, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'modelInfoInClient', 'P_BEAN', '全局变量设置', '', 'modelInfoInClient', '前台用户登陆时显示的组织模型信息', 'wms5', null, null, null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (24, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'SESSION_BASE_ORGAN', 'P_BEAN', '全局变量设置', '', 'baseOrganizationSession', '当前模型全局变量', 'wms5', null, null, null, null, null, null);
insert into global_params (ID, DISCRIMINATOR, PARAM_ID, TYPE, GROUP_NAME, PARAM_VALUE, PARAM_BEAN, DESCRIPTION, MODULE, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (27, 'com.vtradex.thorn.server.config.globalparam.GlobalParam', 'importURL', 'P_STRING', '接口URL配置', 'http://117.78.47.137/services/QsWmsService?wsdl', '', 'erp接口URL地址', 'wms5', null, null, null, null, null, null);

INSERT INTO thorn_business_model
    (
        ID,
        DISCRIMINATOR,
        CODE,
    ...
    (
        1,
        'com.vtradex.thorn.server.model.security.ThornBusinessModel',
        'SYSTEM_MODEL',
        '系统管理模型',
        'ACTIVE',
        '',
...
INTO
    ...
    (
        1,
        'com.vtradex.thorn.server.model.security.ThornBaseOrganization',
         'SYSTEM_MODEL_ORG',
        '系统管理部',
        1,
        '',
...
insert into thorn_roles (ID, CODE, NAME, ADVANCED, ORGAN_ID, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME, BUSINESS_MODEL_ID,CREATE_ORGAN_ID) values (1, 'SUPERVISOR', '超级管理员', 'T', null, 1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'), 1,1);

insert into thorn_roles (ID, CODE, NAME, ADVANCED, ORGAN_ID, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME, BUSINESS_MODEL_ID,CREATE_ORGAN_ID) values (2, 'SYSTEM_MODEL_MGR', '系统模型_管理员', 'T', null, 1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'), 1,1);

insert into thorn_groups (ID, CODE, NAME, ORGAN_ID,BUSINESS_MODEL_ID, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (1, 'SYSMAN', '超级管理组', null,1, 1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'));
insert into thorn_groups (ID, CODE, NAME, ORGAN_ID,BUSINESS_MODEL_ID, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME) values (2, 'SYSTEM_MODEL_GRP', '系统模型_管理组', null,1, 1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'));

insert into thorn_group_role (ROLE_ID, GROUP_ID) values (1, 1);
insert into thorn_group_role (ROLE_ID, GROUP_ID) values (2, 2);

insert into thorn_users (ID, DISCRIMINATOR, CODE, LOGIN_NAME, NAME, PASSWORD, DEPARTMENT, ORGAN_ID, EMAIL, STATUS, LOCALE, EXPIRY_DATE, PASSWORD_EXPIRY_DATE, LONG_EXTEND1, LONG_EXTEND2, LONG_EXTEND3, LONG_EXTEND4, LONG_EXTEND5, STR_EXTEND1, STR_EXTEND2, STR_EXTEND3, STR_EXTEND4, STR_EXTEND5, FIRST_PAGE_ID, NEED_SELECT_PRINTER, CREATOR_ID, CREATOR, CREATED_TIME, LAST_OPERATOR_ID, LAST_OPERATOR, UPDATE_TIME, STR_EXTEND6, STR_EXTEND7, STR_EXTEND8, STR_EXTEND9, STR_EXTEND10, DATE_EXTEND1, DATE_EXTEND2, WL_ID, TIME_ZONE,BUSINESS_MODEL_ID,CREATE_ORGAN_ID) values (1, 'com.vtradex.thorn.server.model.security.User', null, 'admin', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', null, 1, 'yan.li@vtradex.com', 'ACTIVE', 'zh',to_date('2020-09-10','yyyy-MM-dd'), null, null, null, null, null, null, null, null, '', null, null, null, 0, 1, 'admin',to_date('2015-09-10','yyyy-MM-dd'), 1, 'admin',to_date('2015-09-10','yyyy-MM-dd'), null, null, null, null, null, null, null, null, 'GMT+8',1,1);
...
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(59,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'模型管理','PAGE','Y',1,null,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-1','yyyy-MM-dd'),'security','Y','N','thorn5-client');    
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(60,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'模型管理','PAGE','N',1,59,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-1','yyyy-MM-dd'),'maintainThornBusinessModePage','N','Y','thorn5-client');
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(61,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'组织维护','PAGE','N',2,59,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-1','yyyy-MM-dd'),'maintainThornBaseOrganizationPage','N','Y','thorn5-client');
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(62,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'权限管理','PAGE','N',3,59,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-1','yyyy-MM-dd'),'right','Y','N','thorn5-client');   
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(63,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'规则管理','PAGE','N',4,59,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-1','yyyy-MM-dd'),'right','Y','N','thorn5-rule');       
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(64,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'全局参数管理','PAGE','N',5,59,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-1','yyyy-MM-dd'),'maintainIGPPage','N','Y','thorn5-client'); 
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(65,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'报表配置','PAGE','N',6,59,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-1','yyyy-MM-dd'),'maintainReportConfigPage','N','Y','thorn5-rmc'); 
    
    
    
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(66,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'用户管理(模型级)','PAGE','N',1,62,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainThornSystemUserPage','N','Y','thorn5-client');    
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(67,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'角色管理(模型级)','PAGE','N',2,62,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainThornSystemRolePage','N','Y','thorn5-client');
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(68,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'用户组管理(模型级)','PAGE','N',3,62,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainThornSystemGroupPage','N','Y','thorn5-client');


INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(69,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'规则管理(模型级)','PAGE','N',1,63,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainRuleSystemPage','N','Y','thorn5-rule');    
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(70,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'规则表设计(模型级)','PAGE','N',2,63,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainRuleTableSystemPage','N','Y','thorn5-rule'); 
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(71,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'分组管理(模型级)','PAGE','N',3,63,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainGroupRuleTableSystemPage','N','Y','thorn5-rule');  
    
    
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(100,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'组织管理','PAGE','Y',1,null,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'security','Y','N','thorn5-client');    
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(101,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'权限管理','PAGE','N',1,100,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'right','Y','N','thorn5-client');   
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(102,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'规则管理','PAGE','N',2,100,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'rule','Y','N','thorn5-rule');       
    
    
    
 INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
  
   VALUES(103,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'用户管理','PAGE','N',1,101,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainThornUserPage','N','Y','thorn5-client');    
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(104,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'角色管理','PAGE','N',2,101,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainThornRolePage','N','Y','thorn5-client');
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(105,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'用户组管理','PAGE','N',3,101,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainThornGroupPage','N','Y','thorn5-client');
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(106,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'规则表设计','PAGE','N',1,102,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'ruleTable','Y','Y','thorn5-client');
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(107,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'规则表管理','PAGE','N',2,102,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainRuleTableVersionPage','N','Y','thorn5-client');
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(108,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'规则表高级设计','PAGE','N',3,102,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainPrettifyRuleTablePage','N','Y','thorn5-client');
    
    
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(109,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'规则管理','PAGE','N',1,106,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainRulePage','N','Y','thorn5-rule');    
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(110,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'规则表设计','PAGE','N',2,106,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainRuleTablePage','N','Y','thorn5-rule'); 
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(111,'com.vtradex.thorn.server.model.security.ThornModelMenu',1,'分组管理','PAGE','N',3,106,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainGroupRuleTablePage','N','Y','thorn5-rule');            
    
    
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(200,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'组织管理','PAGE','Y',1,null,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'security','Y','N','thorn5-client');    
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(201,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'权限管理','PAGE','N',1,200,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'right','Y','N','thorn5-client');   
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(202,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'规则管理','PAGE','N',2,200,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'rule','Y','N','thorn5-rule');       
  
 
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(203,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'用户管理','PAGE','N',1,201,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainThornUserPage','N','Y','thorn5-client');    
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(204,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'角色管理','PAGE','N',2,201,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainThornRolePage','N','Y','thorn5-client');
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(205,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'用户组管理','PAGE','N',3,201,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainThornGroupPage','N','Y','thorn5-client');
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(206,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'规则表设计','PAGE','N',1,202,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'ruleTable','Y','Y','thorn5-client');
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(207,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'规则表管理','PAGE','N',2,202,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainRuleTableVersionPage','N','Y','thorn5-client');
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(208,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'规则表高级设计','PAGE','N',3,202,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainPrettifyRuleTablePage','N','Y','thorn5-client');
    
    


INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(209,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'规则管理','PAGE','N',1,206,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainRulePage','N','Y','thorn5-rule');    
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(210,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'规则表设计','PAGE','N',2,206,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainRuleTablePage','N','Y','thorn5-rule'); 
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(211,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'分组管理','PAGE','N',3,206,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'maintainGroupRuleTablePage','N','Y','thorn5-rule');            

    
    
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(600,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'收货管理','RF','Y',1,null,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'收货管理','N','N','app');    
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(601,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'出库管理','RF','Y',2,null,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'出库管理','N','N','app'); 
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(602,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'移位/补货','RF','Y',3,null,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'移位/补货','N','N','app');            
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(603,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'库存管理','RF','Y',3,null,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'库存管理','N','N','app');            
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(604,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'盘点管理','RF','Y',3,null,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'盘点管理','N','N','app');            
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(605,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'查询管理','RF','Y',3,null,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'查询管理','N','N','app');            
INSERT INTO thorn_model_menu(ID,DISCRIMINATOR,BUSINESS_MODEL_ID,NAME,TYPE,ROOT,LINE_NO,PARENT_ID,CREATOR_ID,CREATOR,CREATED_TIME,LAST_OPERATOR_ID,LAST_OPERATOR,UPDATE_TIME,KEY_VALUE,BE_MENU,BE_SYSTEM_PAGE,SYSTEM_SRC)
    VALUES(606,'com.vtradex.thorn.server.model.security.ThornModelMenu',null,'任务管理','RF','Y',3,null,1,'admin',to_date('2015-09-10','yyyy-MM-dd'),1,'admin',to_date('2015-09-10','yyyy-MM-dd'),'任务管理','N','N','app');               
    
    

    
-- xiang.li 2017-7-6 11:15:42 add
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsDeliveryOrderStatus','OPEN');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsDeliveryOrderStatus','CLOSED');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsDeliveryOrderStatus','CONFIRMED');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsDeliveryOrderStatus','PARTIALRECEIPT');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsDeliveryOrderStatus','FINISH');

insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsDeliveryOrderCreatedType','SYSTEM');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsDeliveryOrderCreatedType','HAND');


insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsTransportOrderStatus','OPEN');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsTransportOrderStatus','ACTIVE');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsTransportOrderStatus','RECEIVED');


alter table WMS_DELIVERY_ORDER add CONFIRM_DATE TIMESTAMP(6);
alter table WMS_DELIVERY_ORDER add USER_ID NUMBER(19);


--xiang.li 2017-7-12 14:57:40 add
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsFactoryXmlb','0');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsFactoryXmlb','2');

alter table EMAIL_RECORD add EMAIL_ADDRESS varchar(50 char)

--xiang.li 2017-7-15 09:50:50 add
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsDeliveryOrderStatus','ACTIVE');

insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ProductionOrderStatus','ACTIVE');

insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogType','BASIC_ITEM_SAP2WMS');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogType','BASIC_SUPPLIER_SAP2WMS');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogType','BASIC_WAREHOUSE_SAP2WMS');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogType','BUSINESS_PO_SAP2WMS');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogType','BUSINESS_DELIVERYORDER_SAP2WMS');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogType','BUSINESS_ORDERCODE_SAP2WMS');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogType','BUSINESS_PRODUCTORDER_SAP2WMS');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogType','BUSINESS_RESERVEDDATA_SAP2WMS');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogType','BUSINESS_SALEOUTDELIVERY_SAP2WMS');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogType','BUSINESS_POCHECKORDER_SAP2WMS');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogType','BUSINESS_POJSCHECKORDER_SAP2WMS');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogType','BUSINESS_PO_WMS2SAP');

insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','DELIVERY_DOC');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','SURPPLIERBUSINESSBACK');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','DAYLYINVENTORY');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','ITEMPROPERTY');



alter table EMAIL_RECORD add ERROR_INFO varchar(255 char)


--xiang.li 2017-7-15 16:22:59 add
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','RECEIVE_BASIC_REQUEST');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','RECEIVE_BASIC_RESPONSE');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','RECEIVE_BUSINESS_REQUEST');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','RECEIVE_BUSINESS_RESPONSE');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_BASIC_REQUEST');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_BASIC_RESPONSE');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_BUSINESS_REQUEST');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_BUSINESS_RESPONSE');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_DELIVERY');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_EMAIL');

insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_SURPPLIERBUSINESS');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_DAYLYINVENTORY');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_ITEMPROPERTY');


--修改 WmsMinPackageQty 中  minUnit  的字段类型   xiang.li 2017-7-25 11:52:22 
alter table WMS_MINPACKAGE_QTY modify  MIN_UNIT FLOAT;

--xiang.li 2017-8-3 14:49:59 add
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsBolType','VMI');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsBolType','BOL');

--xiang.li 2017年8月8日17:41:34 add
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsBolType','DB');

--xiang.li 2017年8月15日14:50:10 add
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsWarningType','ITEM_ATT');

--xiang.li 2017年8月17日13:47:06 add
--出库预留申请
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsReservedOrderType','Z01');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsReservedOrderType','Z03');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsReservedOrderType','311');
--入库预留申请
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsReservedOrderType','Z02');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsReservedOrderType','Z04');


--xiang.li 2017年8月17日19:11:45 add
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsShippingLotTruckBillType','XSJHD');


--TclWmsMoveType 移动类型
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'TclWmsMoveType','101');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'TclWmsMoveType','122');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'TclWmsMoveType','161');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'TclWmsMoveType','321');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'TclWmsMoveType','261');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'TclWmsMoveType','262');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'TclWmsMoveType','Z42');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'TclWmsMoveType','Z41');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'TclWmsMoveType','Z17');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'TclWmsMoveType','Z18');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'TclWmsMoveType','DB311');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'TclWmsMoveType','301');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'TclWmsMoveType','687');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'TclWmsMoveType','411');



--xiang.li 2017年8月18日11:30:08 add
--Wms2SapInterfaceLogType  报文业务类型
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','RECEIVEINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','CANCELRECEIVEINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','PICKCONFIRMINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','QCRECORDINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','PRODUCTIONINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','PRDRETURNINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','RESINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','OTHEROUTINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','OTHERININFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','BFOUTORININFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','KNDBINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','DBCKINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'Wms2SapInterfaceLogType','XSJHDINFO');

--xiang.li 2017-8-25 14:26:24 add
--ProductionOrderStatus
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ProductionOrderStatus','FINISHED');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ProductionOrderStatus','CANCELED');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ProductionOrderStatus','CLOSE');



--xiang.li 2017-8-25 17:10:36 add
--ProjectType  
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ProjectType','10');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ProjectType','12'); 


--xiang.li 2017年8月28日13:59:09 add
--ConfirmStatus
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ConfirmStatus','OPEN');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ConfirmStatus','CONFIRM'); 
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ConfirmStatus','RECEIVED');

--xiang.li 2017-8-30 11:38:14 add
--ShippingStatus
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ShippingStatus','SHIPPED');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ShippingStatus','UNSHIPPED'); 
--PickingStatus
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'PickingStatus','PICKED');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'PickingStatus','UNPICKED');
--AssignmentStatus
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'AssignmentStatus','ALLOCATED'); 
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'AssignmentStatus','UNALLOCATED');


--xiang.li 2017年8月31日10:51:46 add
--WmsProductionOrderMeetInfoType
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsProductionOrderMeetInfoType','YLD'); 
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsProductionOrderMeetInfoType','GD');

--fs 2017-9-25 16:11:10
--ProductionOrderMeetInfoStatus
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ProductionOrderMeetInfoStatus','COMPLETE'); 
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ProductionOrderMeetInfoStatus','PART_COMPLETE');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ProductionOrderMeetInfoStatus','SHORT');



--xiang.li 2017年9月26日13:18:32
--EmailRecordType
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'EmailRecordType','PO2SUPPLIER'); 
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'EmailRecordType','DELIVERY2SUPPLIER');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'EmailRecordType','SUPPLIER_ACCOUNT');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'EmailRecordType','CHECKBZSUPPLIER'); 
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'EmailRecordType','CHECKJSSUPPLIER');




--xiang.li 2017年9月26日20:39:58
--ProductionOrderMeetInfoStatus
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ProductionOrderMeetInfoStatus','COMPLETE'); 
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ProductionOrderMeetInfoStatus','PART_COMPLETE');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'ProductionOrderMeetInfoStatus','SHORT');
...
--xiang.li 2017年10月9日18:18:15
--WmsSupplierPrintCountType
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsSupplierPrintCountType','TMBD'); 
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsSupplierPrintCountType','DYSHD');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsSupplierPrintCountType','YLDYBQ');

--xiang.li 2017年10月16日11:09:06
--WmsDeliveryOrderDetailStatus
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsDeliveryOrderDetailStatus','FINISH'); 
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsDeliveryOrderDetailStatus','UNFINISH');

--xiang.li 2017年10月16日17:10:55
--PurchaseOrderDetailStatus
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'PurchaseOrderDetailStatus','FINISH'); 
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'PurchaseOrderDetailStatus','UNFINISH');


--xiang.li 2017年10月18日13:38:08
--WmsTaskType
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsTaskType','PUTAWAY'); 
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsTaskType','PICKING');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsTaskType','MOVE'); 
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsTaskType','KITTING_PICKING'); 
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsTaskType','REPLENISHMENT');

--xiang.li 2017年11月8日21:12:02
--InterfaceLogTaskType
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','CHECKORDERINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_RECEIVEINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','IMPORTPRODUCTIONORDER');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','RECEIVE_PRODUCTORDER_IN');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_BFOUTORININFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_CANCELRECEIVEINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_DBCKINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_KNDBINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_OTHERININFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_OTHEROUTINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_PICKCONFIRMINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_PRDRETURNINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_PRODUCTIONINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_QCRECORDINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_SHIPRESINFO');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_WAIT');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'InterfaceLogTaskType','SEND_XSJHDINFO');

--xiang.li 2017年11月10日11:45:43
--WmsProductionOrderMeetInfoType
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsProductionOrderMeetInfoType','JIT');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsProductionOrderMeetInfoType','MON_GD');


--xiang.li	2017年11月15日17:03:14
--WmsInventoryLogType
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsInventoryLogType','GYS_CHANGE');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsInventoryLogType','XT_CHANGE');

insert into enumerate (ID, ENUM_TYPE, ENUM_VALUE)  VALUES (seq_enumerate.nextval,'kld','0-7');
insert into enumerate (ID, ENUM_TYPE, ENUM_VALUE)  VALUES (seq_enumerate.nextval,'kld','8-15');
insert into enumerate (ID, ENUM_TYPE, ENUM_VALUE)  VALUES (seq_enumerate.nextval,'kld','16-30');
insert into enumerate (ID, ENUM_TYPE, ENUM_VALUE)  VALUES (seq_enumerate.nextval,'kld','31-60');
insert into enumerate (ID, ENUM_TYPE, ENUM_VALUE)  VALUES (seq_enumerate.nextval,'kld','61-90');
insert into enumerate (ID, ENUM_TYPE, ENUM_VALUE)  VALUES (seq_enumerate.nextval,'kld','>90');

insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsItemScanCode','Y');
insert into enumerate (id,enum_type,enum_value) values(seq_enumerate.nextval,'WmsItemScanCode','N');