...
/**
 * <p>DT_Stock_Move complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DT_Stock_Move">
 *   &lt;complexContent>
 ...
 *                   &lt;element name="UMWRK" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *                   &lt;element name="UMLGO" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "DT_Stock_Move", propOrder = {
    "command",
    "count",
    "frbnr",
    "budat",
...
public class DTStockMove {
    ...
    protected List<DTStockMove.ITEMS> items;
     ...
     * {@link DTStockMove.ITEMS }
     * 
     * 
     */
    public List<DTStockMove.ITEMS> getITEMS() {
        if (items == null) {
            items = new ArrayList<DTStockMove.ITEMS>();
        }
        return this.items;
    }
    ...
    public static class ITEMS {
         ...
         *     
         */
        public void setUMWRK(String value) {
            this.umwrk = value;
        }
