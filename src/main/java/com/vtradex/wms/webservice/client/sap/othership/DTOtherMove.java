...
/**
 * <p>DT_Other_Move complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DT_Other_Move">
 *   &lt;complexContent>
...
@XmlType(name = "DT_Other_Move", propOrder = {
    "command",
    "count",
    "frbnr",
    "budat",
...
public class DTOtherMove {
    ...
    protected List<DTOtherMove.ITEMS> items;
     ...
     * {@link DTOtherMove.ITEMS }
     * 
     * 
     */
    public List<DTOtherMove.ITEMS> getITEMS() {
        if (items == null) {
            items = new ArrayList<DTOtherMove.ITEMS>();
        }
        return this.items;
    }
