...
/**
 * <p>DT_Receipt_Return complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DT_Receipt_Return">
 *   &lt;complexContent>
...
@XmlType(name = "DT_Receipt_Return", propOrder = {
    "command",
    "count",
    "frbnr",
    "budat",
...
public class DTReceiptReturn {
    ...
    protected List<DTReceiptReturn.ITEMS> items;
     ...
     * {@link DTReceiptReturn.ITEMS }
     * 
     * 
     */
    public List<DTReceiptReturn.ITEMS> getITEMS() {
        if (items == null) {
            items = new ArrayList<DTReceiptReturn.ITEMS>();
        }
        return this.items;
    }
