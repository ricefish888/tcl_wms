...
/**
 * <p>DT_Scrap_Out complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DT_Scrap_Out">
 *   &lt;complexContent>
...
@XmlType(name = "DT_Scrap_Out", propOrder = {
    "command",
    "count",
    "frbnr",
    "budat",
...
public class DTScrapOut {
    ...
    protected List<DTScrapOut.ITEMS> items;
     ...
     * {@link DTScrapOut.ITEMS }
     * 
     * 
     */
    public List<DTScrapOut.ITEMS> getITEMS() {
        if (items == null) {
            items = new ArrayList<DTScrapOut.ITEMS>();
        }
        return this.items;
    }
