...
//	private WmsWarehouse warehouse;
	...
	/**是否明细生成捡配单*/
	private Boolean beDetailCreatePt = Boolean.FALSE;
	/**销售单号*/
	...
	public Boolean getBeDetailCreatePt() {
		return beDetailCreatePt;
	}

	public void setBeDetailCreatePt(Boolean beDetailCreatePt) {
		this.beDetailCreatePt = beDetailCreatePt;
	}
