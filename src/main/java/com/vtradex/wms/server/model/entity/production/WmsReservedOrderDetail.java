...
public class WmsReservedOrderDetail extends VersionalEntity {
	...
	/**是否生成拣货单*/
	private Boolean isCreatePick = Boolean.FALSE;
	/**是否生成收货单*/
	private Boolean isCreateASN = Boolean.FALSE;
	
	public Boolean getIsCreateASN() {
		return isCreateASN;
	}

	public void setIsCreateASN(Boolean isCreateASN) {
		this.isCreateASN = isCreateASN;
	}
	...
	public Boolean getIsCreatePick() {
		return isCreatePick;
	}

	public void setIsCreatePick(Boolean isCreatePick) {
		this.isCreatePick = isCreatePick;
	}
