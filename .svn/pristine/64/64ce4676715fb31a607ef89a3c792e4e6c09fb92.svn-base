 ...
 * 2017-07-18T14:09:26.742+08:00
 * Generated source version: 2.6.2
 * 
 */
public final class SIWMSConfirmOB_HTTPPort_Client {

    private static final QName SERVICE_NAME = new QName("http://wms.tcl.com/vendor_confirm", "SI_WMS_Confirm_OBService");

    private SIWMSConfirmOB_HTTPPort_Client() {
    }
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        SIWMSConfirmOB port = ss.getHTTPPort();  
