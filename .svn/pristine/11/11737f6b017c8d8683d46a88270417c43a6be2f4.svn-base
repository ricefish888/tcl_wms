...
public class WmsDeliveryOrderDetail extends VersionalEntity {
	...
	/**
	 * 状态
	 * {@link WmsDeliveryOrderDetailStatus}}
	 */
	private String status=WmsDeliveryOrderDetailStatus.UNFINISH;
	...
	public void addTheDeliveryQuantityBu(Double theDeliveryQuantityBu){
		this.theDeliveryQuantityBu  = this.theDeliveryQuantityBu  + theDeliveryQuantityBu;
//		this.theDeliveryQuantityBu = DoubleUtils.add(this.theDeliveryQuantityBu, theDeliveryQuantityBu);
	}
	
	public void subTheDeliveryQuantityBu(Double theDeliveryQuantityBu){
		this.theDeliveryQuantityBu = DoubleUtils.sub(this.theDeliveryQuantityBu, theDeliveryQuantityBu);
	}
	...
	public void subQuantity(Double quantity){
        this.quantity = DoubleUtils.sub(this.quantity, quantity);
    }
