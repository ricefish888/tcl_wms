 ...
 * 2017-07-04T12:04:30.963+08:00
 * Generated source version: 2.6.2
 * 
 */
public final class ZRFCWMSMSGRETURNPortType_HTTPPort_Client {

    private static final QName SERVICE_NAME = new QName("urn:sap-com:document:sap:rfc:functions", "ZRFC_WMS_MSG_RETURNService");

    private ZRFCWMSMSGRETURNPortType_HTTPPort_Client() {
    }
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        ZRFCWMSMSGRETURNPortType port = ss.getHTTPPort();  
