...
public class ExcelHelper {
	...
	/**解析处理跳过空白行*/
	public static final Boolean PARSE_BREAK_EMPTY_ROW = Boolean.TRUE;
        ...
        try {
            ...
            for(Integer headRow : headRows) {
                ...
                for (int r = headRow+1; r < rows; r++) {
                    ...
                    if(PARSE_BREAK_EMPTY_ROW && isEmptyRow) { //如果跳过空行，且整行没有内容
                    	continue;
                    }
...
//    }
	...
	public static void main(String[] args) {
		ExcelHelper a = new ExcelHelper();
		 ...
		 File f = new File("/Users/administrator/Desktop/1.xls");
		 
		result = a.parseExcel2List(f);
            ...
            for (int r=0; r<row; r++) {
                ...
                for (int c=0; c<col; c++) {
                    ...
                    if (StringUtils.isEmpty(value)) {
                        ...
                        cell = new Number(c, r, NumberUtils.createDouble(value.toString()).doubleValue(), doubleCellFormat);
                    } else {
