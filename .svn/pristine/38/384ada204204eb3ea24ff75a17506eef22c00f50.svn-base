...
public class ProductionOrderDetail extends VersionalEntity {
	...
	/**是否可修改下发数量*/
	private Boolean beChangeXfQty = Boolean.FALSE;

	public Boolean getBeChangeXfQty() {
		return beChangeXfQty;
	}

	public void setBeChangeXfQty(Boolean beChangeXfQty) {
		this.beChangeXfQty = beChangeXfQty;
	}
