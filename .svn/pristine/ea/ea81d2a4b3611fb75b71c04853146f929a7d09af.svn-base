...
/**
 * <p>DT_IND_Inspect complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DT_IND_Inspect">
 *   &lt;complexContent>
...
@XmlType(name = "DT_IND_Inspect", propOrder = {
    "command",
    "count",
    "frbnr",
    "budat",
...
public class DTINDInspect {
    ...
    protected List<DTINDInspect.ITEMS> items;
     ...
     * {@link DTINDInspect.ITEMS }
     * 
     * 
     */
    public List<DTINDInspect.ITEMS> getITEMS() {
        if (items == null) {
            items = new ArrayList<DTINDInspect.ITEMS>();
        }
        return this.items;
    }
