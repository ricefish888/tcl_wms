...
/**
 * <p>DT_Prd_Move complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DT_Prd_Move">
 *   &lt;complexContent>
...
@XmlType(name = "DT_Prd_Move", propOrder = {
    "command",
    "count",
    "frbnr",
    "budat",
...
public class DTPrdMove {
    ...
    protected List<DTPrdMove.ITEMS> items;
     ...
     * {@link DTPrdMove.ITEMS }
     * 
     * 
     */
    public List<DTPrdMove.ITEMS> getITEMS() {
        if (items == null) {
            items = new ArrayList<DTPrdMove.ITEMS>();
        }
        return this.items;
    }
