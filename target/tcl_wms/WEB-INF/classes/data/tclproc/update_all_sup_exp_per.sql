create or replace procedure update_all_sup_exp_per (error_message OUT VARCHAR2)
...
select u.id as userid from thorn_users u where u.login_name in (
...
BEGIN
    ...
    LOOP
          ...
          INSERT_SUP_EXP_PER(uinfo.userid,errorinfo);
    END LOOP;
    CLOSE c_supuserdata;
    COMMIT;
    EXCEPTION
