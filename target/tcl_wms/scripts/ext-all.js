...
Ext.extend(Ext.menu.Menu, Ext.util.Observable, {
	...
	autoWidth : function() {
		...
		if(height > document.body.clientHeight - 50){
			D.setHeight(document.body.clientHeight - 50);
		}
	},
...
Ext
		.extend(
				...
				Ext.util.Observable,
				{
					...
					autoFill : false,
					forceFit : false,
					/**sortClasses : ["sort-none", "sort-asc", "sort-desc" ],**/
					sortClasses : ["sort-none", "sort-none", "sort-none" ],
					sortNoneText : "Clear sort",
					...
					renderUI : function() {
						...
						if (D.enableHdMenu !== false) {
							...
							this.hmenu.add({
								id : "none",
								text : this.sortNoneText,
								cls : "xg-hmenu-sort-none"
							}, {
								id : "asc",
					...
					handleHdDown : function(F, D) {
						if (Ext.fly(D).hasClass("x-grid3-hd-btn")) {
							...
							B.get("none").setDisabled(!A.isSortable(C));
