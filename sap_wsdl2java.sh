...
#库存调拨 invMove.wsdl
#$CXF_HOME/bin/wsdl2java -frontend jaxws21 -p com.vtradex.wms.webservice.client.sap.invmove -d $(pwd)/src/main/java -client $(pwd)/src/main/resources/wsdl/invMove.wsdl
